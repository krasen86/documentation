...
![UI/Client Subsystem Sequence Diagram for Use Case: Make a booking](./diagrams/v2/Sequence_UI_Use_case_Booking_-_V2.png.png "UI/Client Subsystem Sequence Diagram for Use Case: Make a booking")
